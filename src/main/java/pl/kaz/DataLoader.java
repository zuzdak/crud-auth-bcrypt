...
//
//import com.vega.domain.Logs;
////import com.vega.domain.Author;
////import com.vega.domain.Post;
//import com.vega.repository.AuthorRepository;
//import com.vega.repository.LogsRepository;
//import com.vega.repository.PostRepository;
//import com.vega.service.LogsService;
...
//	private AuthorRepository authorRepository;
	...
	//public DataLoader(LogsRepository logsRepository ){
...
//		authorRepository.deleteAll();
		...
		//  ---------create an author
// 		Author dv = new Author("Dan","Vega","danvega@gmail.com",true);
//		authorRepository.save(dv);
	...
	/*private void createAuthors() {
		Author jv = new Author("Joe","Vega","jvega@vega.com");
		authorRepository.save(jv);
		Author av = new Author("Andy","Vega","avega@vega.com");
		authorRepository.save(av);
		Author kv = new Author("Katie","Vega","kvega@vega.com");
	...
	/*private void createPosts(Author author) {
		...
		Date yesterday = null;
		try {
			yesterday = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("2017-05-02 14:50:00");
